"""
Django settings for online_assignment_management project.
...
# ROOT_URLCONF = 'online_assignment_management.urls'
...
# WSGI_APPLICATION = 'online_assignment_management.wsgi.application'
